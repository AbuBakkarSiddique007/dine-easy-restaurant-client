    ...
    return (
        <footer className="w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 text-white">
                <aside className="bg-[#1f2937] p-10 flex flex-col justify-start items-end space-y-3">
                    <h1 className="text-xl md:text-2xl font-bold">CONTACT US</h1>
                    <p className="flex flex-col text-base md:text-lg text-right space-y-1">
                ...
                <nav className="bg-[#111827] p-10 flex flex-col justify-start items-start space-y-3">
                    <h6 className="text-xl md:text-2xl font-bold">Follow US</h6>
                    <p className="text-base md:text-lg">Join us on social media</p>
            ...
            <div className="bg-gray-900 text-white text-center py-4 text-sm md:text-base">
                <p>
                    Copyright © {new Date().getFullYear()} - All rights reserved by
                    DineEasy Restaurant Ltd.
                </p>
            </div>
        </footer>
    );
